...
public class ProductService {
    ...
    public InvoiceItemDto createProduct(InvoiceItemDto invoiceItemDto) {
        Optional<InvoiceItem> isProductExisting = productRepository.findProductByNameAndPrice(invoiceItemDto.getName(), invoiceItemDto.getPrice());
    ...
    public InvoiceItemDto updateProduct(InvoiceItemDto invoiceItemDto) {
        InvoiceItem invoiceItem = productRepository.findById(invoiceItemDto.getId())
